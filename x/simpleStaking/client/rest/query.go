...
func registerQueryRoutes(cliCtx context.CLIContext, r *mux.Router, cdc *codec.Codec) {
	...
	// r.HandleFunc("/staking/delegators/{delegatorAddr}/delegations", delegatorDelegationsHandlerFn(cliCtx, cdc)).Methods("GET")

	// // Get all unbonding delegations from a delegator
	// r.HandleFunc("/staking/delegators/{delegatorAddr}/unbonding_delegations", delegatorUnbondingDelegationsHandlerFn(cliCtx, cdc)).Methods("GET")

	// // Get all staking txs (i.e msgs) from a delegator
	// r.HandleFunc("/staking/delegators/{delegatorAddr}/txs", delegatorTxsHandlerFn(cliCtx, cdc)).Methods("GET")

	// // Query all validators that a delegator is bonded to
	// r.HandleFunc("/staking/delegators/{delegatorAddr}/validators", delegatorValidatorsHandlerFn(cliCtx, cdc)).Methods("GET")

	// // Query a validator that a delegator is bonded to
	// r.HandleFunc("/staking/delegators/{delegatorAddr}/validators/{validatorAddr}", delegatorValidatorHandlerFn(cliCtx, cdc)).Methods("GET")

	// // Query a delegation between a delegator and a validator
	// r.HandleFunc("/staking/delegators/{delegatorAddr}/delegations/{validatorAddr}", delegationHandlerFn(cliCtx, cdc)).Methods("GET")

	// // Query all unbonding delegations between a delegator and a validator
	// r.HandleFunc("/staking/delegators/{delegatorAddr}/unbonding_delegations/{validatorAddr}", unbondingDelegationHandlerFn(cliCtx, cdc)).Methods("GET")

	// // Query redelegations (filters in query params)
	// r.HandleFunc("/staking/redelegations", redelegationsHandlerFn(cliCtx, cdc)).Methods("GET")

	// // Get all validators
	// r.HandleFunc("/staking/validators", validatorsHandlerFn(cliCtx, cdc)).Methods("GET")

	// // Get a single validator info
	// r.HandleFunc("/staking/validators/{validatorAddr}", validatorHandlerFn(cliCtx, cdc)).Methods("GET")

	// // Get all delegations to a validator
	// r.HandleFunc("/staking/validators/{validatorAddr}/delegations", validatorDelegationsHandlerFn(cliCtx, cdc)).Methods("GET")

	// // Get all unbonding delegations from a validator
	// r.HandleFunc("/staking/validators/{validatorAddr}/unbonding_delegations", validatorUnbondingDelegationsHandlerFn(cliCtx, cdc)).Methods("GET")

	// Get the current state of the staking pool
	r.HandleFunc("/staking/pool", poolHandlerFn(cliCtx, cdc)).Methods("GET")

	// Get the current staking parameter values
	r.HandleFunc("/staking/parameters", paramsHandlerFn(cliCtx, cdc)).Methods("GET")
