...
import (
	...
	"github.com/marbar3778/simpleM/x/simpleStaking/client/cli"
...
func NewAppModule(keeper Keeper, fcKeeper types.FeeCollectionKeeper, accKeeper AccountKeeper) AppModule {
...
func (am AppModule) RegisterInvariants(ir sdk.InvariantRouter) {
	RegisterInvariants(ir, am.keeper, am.fcKeeper, am.accKeeper)
}
