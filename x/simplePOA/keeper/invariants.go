...
func RegisterInvariants(ir sdk.InvariantRouter, k Keeper, f types.FeeCollectionKeeper, am types.AccountKeeper) {
...
func AllInvariants(k Keeper, f types.FeeCollectionKeeper, am types.AccountKeeper) sdk.Invariant {

	return func(ctx sdk.Context) error {
		err := SupplyInvariants(k, f, am)(ctx)
		if err != nil {
			return err
		}
...
// nolint: unparam
func SupplyInvariants(k Keeper, f types.FeeCollectionKeeper, am types.AccountKeeper) sdk.Invariant {
	...
	return func(ctx sdk.Context) error {
		...
		k.IterateValidators(ctx, func(_ int64, validator types.Authority) bool {
